...
void Gui::AddText(GuiText & text)
{
	texts.push_back(text);
}

void Gui::AddText(float x, float y, string content)
{
	GuiText text;
...
void Gui::AddText(float x, float y, float r, float g, float b, string content)
{
	GuiText text;
	text.Position = D3DXVECTOR2(x, y);
...
void Gui::AddText(D3DXVECTOR2 position, D3DXCOLOR color, string content)
{
	GuiText text;
