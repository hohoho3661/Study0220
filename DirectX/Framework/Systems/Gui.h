...
public:
	...
	void AddText(float x, float y, string content);
	void AddText(float x, float y, float r, float g, float b, string content);
	void AddText(D3DXVECTOR2 position, D3DXCOLOR color, string content);
